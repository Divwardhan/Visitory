...
function Home() {
  ...
  var isStudentLoggedIn = localStorage.getItem('token')&& !localStorage.getItem('guardLoggedIn') === 'true' ;

  var isGuardLoggedIn = localStorage.getItem('guardLoggedIn') === 'true' && localStorage.getItem('token');
